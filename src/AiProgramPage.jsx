...
/* ================================================================================
   ...
   FIX: Sections are full-width, <page-container> is inside.
   ================================================================================ */

const HeroSection = () => (
  <section className="hero-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const PersonaSection = () => (
  <section className="persona-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const PortfolioSection = () => (
  <section id="labs" className="portfolio-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const ProgramStructure = () => (
  <section id="program" className="program-structure-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const SyllabusAccordion = () => (
  <section id="syllabus" className="syllabus-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const InstructorSection = () => (
  <section className="instructor-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const PricingSection = () => (
  <section id="pricing" className="pricing-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const FAQAccordion = () => (
  <section id="faq" className="faq-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
...
const FooterCTA = () => (
  <section className="footer-cta-section"> {/* No page-container here */}
    <div className="page-container"> {/* Container is inside */}
